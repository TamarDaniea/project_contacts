                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    {userToShow.mainContact && (
                      <Box component="span" sx={{ display: 'inline-flex', alignItems: 'center', color: 'gold' }}>
                        ...
                        <Typography variant="body2" sx={{ fontSize: 'small' }}>Main Contact</Typography> 
                      </Box>
                    )}
                  </Box>
                  <IconButton disableRipple sx={{ padding: 0, outline: 'none', '&:focus': { outline: 'none' } }}>
                    <EditIcon style={{ color: '#277DBE', fontSize: 'small' }} />
                    <Typography variant="body2" style={{ color: '#277DBE', fontSize: 'small' }}>edit</Typography>
                  </IconButton>
                </Box>
